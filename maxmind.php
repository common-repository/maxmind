...
/*
Plugin Name: Maxmind
Plugin URI: http://www.vanmeerdervoort.nl/wordpress-maxmind-plugin
Description: Includes the Maxmind Hotel Booking system in your wordpress as a widget. You need a Maxmind.eu account!
Version: 1.0.1
...
<tr valign="top">
	       ...
	       <td><input type="checkbox" name="vm_select_hotel" value="1" <?php checked( 1 == get_option('vm_select_hotel')); ?>" /> Allow Hotel selection</td>
	        ...
	        <td><input type="text" name="vm_maxmind_url" value="<?php echo get_option('vm_maxmind_url'); ?>" /> (the url of your personalized page on maxengine, shortcode: [vm-maxmind-button text="Text on your button"])</td>
	        </tr>
				<tr valign="top">
